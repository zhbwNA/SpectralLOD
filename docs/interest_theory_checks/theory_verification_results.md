Interest-driven verification target: theory-level checks for new implementation functions, not a single-paper reproduction.
Created: 2026-05-24
Updated: 2026-05-25
...
- `../GGGLS24_pml/fig_gggls_pml_decay.png`
- `../GGGLS24_pml/fig_gggls_pml_width_alpha_sweep.png`
- `../GGGLS24_pml/fig_gggls_pml_convergence.png`
